...
| Order | Batch ID | Focus | v2.0 parents | Shared-core? |
| ---: | --- | --- | --- | --- |
| 1 | `ccna-v20-p0-addressing-troubleshoot` | Elevate IPv4/IPv6/DHCP to troubleshoot depth | 1.3, 1.4, 1.7 | yes |
| 2 | `ccna-v20-p0-l2l3-troubleshoot` | New 2.4 parent + STP configure depth | 2.4, 2.5 | yes |
| 3 | `ccna-v20-p0-routing-expansion` | Static troubleshoot, OSPFv3, FHRP status | 3.2, 3.3, 3.4 | yes |
| 4 | `ccna-v20-p0-ai-ops` | Agentic/generative AI + Ansible execute | 5.1, 5.2, 5.5 | no |
| 5 | `ccna-v20-p1-services-security` | DNS diagnose, L2 security expands, AAA/NAT | 4.1, 4.3, 4.4, 4.6, 4.7 | yes |
| 6 | `ccna-v20-p1-client-wireless` | Client connectivity + wireless sub-bullets | 1.5, 1.6 | yes |
