...
|-------|--------|------------|----------|------------------|---------------------------|-------------------|----------------|
| `osi-model` · OSI Model | network-fundamentals | pass | yes | partial | 0 | pending | NO |
...
| `subnetting` · Subnetting | network-fundamentals | pass | yes | partial | 0 | pending | NO |
...
| `switching` · Switching | network-access | pass | yes | partial | 0 | pending | NO |
| `vlans` · VLANs | network-access | pass | yes | none | 0 | pending | NO |
| `trunking` · Trunking | network-access | pass | yes | none | 0 | pending | NO |
| `stp` · STP | network-access | pass | yes | partial | 0 | pending | NO |
| `routing-fundamentals` · Routing Fundamentals | ip-connectivity | pass | yes | none | 0 | pending | NO |
| `static-routes` · Static Routes | ip-connectivity | pass | yes | none | 0 | pending | NO |
| `ospf-basics` · OSPF Basics | ip-connectivity | pass | yes | partial | 0 | pending | NO |
| `nat` · NAT | ip-connectivity | pass | yes | partial | 0 | pending | NO |
...
**Findings triaged = partial:** topic has ledger row(s) from the HIGH seed still pending decision.  
**Ship-before blockers open:** count of ledger rows with `decision=ship-before-signoff` and empty `prOrCommit` (0 until triage marks ship-before).
