...
export function VirtualKeyboard({ activeNotes, onPlay, startNote = 48, endNote = 72, visibleNotes, emphasizedNotes, labelNaturals = false }: { activeNotes: Set<number>; onPlay?: (note: number) => void; startNote?: number; endNote?: number; visibleNotes?: Set<number>; emphasizedNotes?: Set<number>; labelNaturals?: boolean }) {
